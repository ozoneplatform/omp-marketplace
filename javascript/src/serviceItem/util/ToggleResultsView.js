...
function ($, _) {
    ...
    function setUpEvents(){
        ...
        */
        ...
        $sortByCalendar.on("click", function(){
            ...
            $(".search_results_sort").trigger("resetSorting", ['approvalDate', sortOrder]);
            ...
            var me = $(this);
            getSortedResults(view.type, view.name, "approvalDate", "asc",function(data){
                replaceSortedData(view.type, data);
            });
        }).on('sortDescending', function(event, view){
            var me = $(this);
            getSortedResults(view.type, view.name, "approvalDate", "desc",function(data){
                replaceSortedData(view.type, data);
            });
        }).on('showAscending', function(){
    ...
    function updateFilterButtons () {
        ...
        else if(params.sort === 'approvalDate') {
