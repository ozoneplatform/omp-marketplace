...
define([
    ...
    'jquery',
    'sinon'
], function(SelectedFilterView, FilterView, Backbone, Marketplace, _, $, sinon) {
    'use strict';
    ...
    describe('FilterView', function() {
        ...
        it('has an a tag with the correct href', function() {
            ...
            expect(view.$('a').attr('href'))
                .to.be('/test-server/search/removeFilter?field=removeType&values=2');
        });
