...
function(AppData, TabPaneView, Marketplace, Field, Intents, Required, Backbone, Handlebars, $, Moment, _, _s) {
    ...
    //Default config list
    //types, categories, domain, state, releaseDate, lastActivity, owners, Government Sponsor, Sponsor Contact, organization, Alternate POC Info, Technical POC Info, Support POC Info, launchUrl, scoreCard, requirements, dependencies, resources, guid
    ...
    function AdditionalSpecificationsConfiguration (configuredFields) {
        ...
        this.primaryCharacteristicsFields = removeExisting(['title', 'types', 'state', 'agency', 'version', 'categories', 'releaseDate', 'lastActivity']);
