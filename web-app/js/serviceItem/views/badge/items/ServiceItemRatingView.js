  ...
  'marketplace'
	...
	if(!affiliatedMarketplaceSearchResourceBundle) {
		affiliatedMarketplaceSearchResourceBundle = {
			activeStar: Marketplace.context + '/themes/common/images/activeStar.png',
			activeHalfStar: Marketplace.context + '/themes/common/images/activeHalfStar.png',
			inActiveStar: Marketplace.context + '/themes/common/images/inActiveStar.png'
		};
	}
