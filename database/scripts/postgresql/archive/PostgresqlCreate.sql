...
ALTER TABLE service_item ADD approval_date TIMESTAMP WITH TIME ZONE;
...
INSERT INTO application_configuration (code, group_name, mutable, sub_group_name, sub_group_order, title, type, value, "version") VALUES ('store.logo', 'BRANDING', TRUE, NULL, 2, ' ', 'Image', '/static/themes/gold.theme/images/Mp_logo.png', 0);

INSERT INTO application_configuration (code, group_name, mutable, sub_group_name, sub_group_order, title, type, value, "version") VALUES ('store.icon', 'BRANDING', TRUE, NULL, 3, ' ', 'Image', '/static/themes/common/images/agency/agencyDefault.png', 0);
...
INSERT INTO application_configuration (code, group_name, mutable, sub_group_name, sub_group_order, title, type, value, "version") VALUES ('about.box.image', 'BRANDING', TRUE, 'About Information', 2, ' ', 'Image', '/static/themes/gold.theme/images/Mp_logo_128x128.png', 0);
...
INSERT INTO application_configuration (code, group_name, mutable, sub_group_name, sub_group_order, title, type, value, "version") VALUES ('store.open.search.fav.icon', 'BRANDING', TRUE, 'Open Search', 3, ' ', 'Image', '/static/themes/gold.theme/images/favicon.ico', 0);

INSERT INTO application_configuration (code, group_name, mutable, sub_group_name, sub_group_order, title, type, value, "version") VALUES ('store.open.search.site.icon', 'BRANDING', TRUE, 'Open Search', 4, ' ', 'Image', '/static/themes/common/images/themes/default/market_64x64.png', 0);
...
INSERT INTO application_configuration (code, group_name, mutable, sub_group_name, sub_group_order, title, type, value, "version") VALUES ('store.quick.view.detail.fields', 'ADDITIONAL_CONFIGURATION', TRUE, 'Quick View', 1, ' ', 'String', 'types, categories, state, releasedDate, lastActivity, owners, organization, Alternate POC Info, Technical POC Info, Support POC Info, launchUrl', 0);
