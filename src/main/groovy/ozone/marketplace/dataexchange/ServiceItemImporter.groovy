...
class ServiceItemImporter extends AbstractImporter {
    ...
    protected boolean shouldUpdate(JSONObject json, existingMatch) {
        ...
        def lastActivityString = json.lastActivity?.activityTimestamp
        if (lastActivityString && lastActivityString != null /*JSONObject.NULL*/) {
            try{
                ...
                log.warn("Invalid last activity date ${json.lastActivity.activityTimestamp}", e)
            }
        }
                ...
                if (addComment) {
                    ...
                    itemCommentService.saveItemComment(
                        [
                            ...
                            newUserRating: itemCommentJson.rate == null /*JSONObject.NULL*/ ? '' : itemCommentJson.rate
                        ], itemCommentJson?.author?.username, false
                    )
                }
            }
        }
