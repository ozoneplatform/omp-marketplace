...
class TransactionUtils {
     ...
     */
    static boolean ensureSession(SessionFactory sessionFactory, org.apache.log4j.Logger logger) {
     ...
     * @return boolean was a HBM session bound to the thread
     */
    static boolean ensureSession(SessionFactory sessionFactory, Logger logger) {
        assert sessionFactory != null
        def boundSession = false
