...
trait ControllerTestMixin<T extends Controller & ServletAttributes> {
    ...
    String getRequestContextPath() {
        controller.request.contextPath
    }
    ...
    static <T> T verifyProperty(Map object, String property, Class<T> clazz) {
        assert object.containsKey(property)
    ...
    static <T> T verifyElement(List object, int index, Class<T> clazz) {
