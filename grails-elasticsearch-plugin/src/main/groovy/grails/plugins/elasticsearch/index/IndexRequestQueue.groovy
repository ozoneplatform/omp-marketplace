...
class IndexRequestQueue {
    ...
    void addIndexRequest(instance, Serializable id = null) {
    ...
    void addDeleteRequest(instance) {
        ...
        synchronized (this) {
            deleteRequests.add(indexEntityKeyFromInstance(unwrappedInstance))
        }
    }

    private IndexEntityKey indexEntityKeyFromInstance(instance) {
    ...
    private XContentBuilder toJSON(instance) {
        try {
