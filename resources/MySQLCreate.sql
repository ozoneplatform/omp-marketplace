...
create table service_item_activity (id bigint not null auto_increment, version bigint not null, created_date datetime, action varchar(255) not null, service_item_id bigint not null, service_item_version bigint, created_by_id bigint, edited_date datetime, edited_by_id bigint, activity_date datetime not null, author_id bigint not null, service_item_activities_idx integer, primary key (id)) ENGINE=InnoDB;
...
ALTER TABLE `service_item` ADD `approved_date` DATETIME;
...
INSERT INTO `application_configuration` (`code`, `group_name`, `mutable`, `sub_group_name`, `sub_group_order`, `title`, `type`, `value`, `version`) VALUES ('store.logo', 'BRANDING', 1, NULL, 2, ' ', 'Image', '/marketplace/themes/gold.theme/images/Mp_logo.png', 0);

INSERT INTO `application_configuration` (`code`, `group_name`, `mutable`, `sub_group_name`, `sub_group_order`, `title`, `type`, `value`, `version`) VALUES ('store.icon', 'BRANDING', 1, NULL, 3, ' ', 'Image', '/marketplace/themes/common/images/agency/agencyDefault.png', 0);
...
INSERT INTO `application_configuration` (`code`, `group_name`, `mutable`, `sub_group_name`, `sub_group_order`, `title`, `type`, `value`, `version`) VALUES ('about.box.image', 'BRANDING', 1, 'About Information', 2, ' ', 'Image', '/marketplace/themes/gold.theme/images/Mp_logo_128x128.png', 0);
...
INSERT INTO `application_configuration` (`code`, `group_name`, `mutable`, `sub_group_name`, `sub_group_order`, `title`, `type`, `value`, `version`) VALUES ('store.open.search.fav.icon', 'BRANDING', 1, 'Open Search', 3, ' ', 'Image', '/marketplace/themes/gold.theme/images/favicon.ico', 0);

INSERT INTO `application_configuration` (`code`, `group_name`, `mutable`, `sub_group_name`, `sub_group_order`, `title`, `type`, `value`, `version`) VALUES ('store.open.search.site.icon', 'BRANDING', 1, 'Open Search', 4, ' ', 'Image', '../images/themes/default/market_64x64.png', 0);
...
INSERT INTO `application_configuration` (`code`, `group_name`, `mutable`, `sub_group_name`, `sub_group_order`, `title`, `type`, `value`, `version`) VALUES ('store.quick.view.detail.fields', 'ADDITIONAL_CONFIGURATION', 1, 'Quick View', 1, ' ', 'String', 'types, categories, state, releaseDate, lastActivity, owners, organization, Alternate POC Info, Technical POC Info, Support POC Info, launchUrl', 0);
