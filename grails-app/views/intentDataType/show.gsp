...
<html>
    ...
    <div id="marketContentWrapper" class="widget-marketContentWrapper-wleftbar bootstrap-active">
          <div id="marketContent" style="padding-top: 2%; ">
                ...
                <div class="body">
                    <h1><g:message code="intentDataType.view.title" encodeAs="HTML" /></h1>
                        ...
                        <table class="tableNoBorder table" style="width:auto;" cellpadding="0" cellspacing="0">
                            <tbody>
                                <tr class="prop">
                                    ...
                                    <td  class="admin_create_field">${fieldValue(bean:intentDataType, field:'title')}</td>
                                </tr>
                                <tr class="prop">
                                    <td  class="nameAdmin"><g:message code="label.uuid" encodeAs="HTML" /></td>
                                    <td  class="admin_create_field">${intentDataType.uuid.encodeAsHTML()}</td>
                                </tr>
                                <tr class="prop">
                                    <td  class="nameAdmin"><g:message code="label.created" encodeAs="HTML" /></td>
                                    <td  class="admin_create_field">${AdminObjectFormatter.createdDateDisplay(intentDataType)}</td>
                                </tr>
                                 <tr class="prop">
                                ...
                                <tr class="prop">
                                    ...
                                    <td  class="admin_create_field">${AdminObjectFormatter.editedDateDisplay(intentDataType)}</td>
                                </tr>
                                 <tr class="prop">
                                ...
                                <tr class="prop">
                                    ...
                                    <td  class="admin_create_field">${fieldValue(bean:intentDataType, field:'description').replaceAll("\n","<br />")}</td>
                                </tr>
                                <tr>
                                    <td class="tableNoBorderNoWrap">
                                        ...
                                        <g:form name="theForm">
                                                ...
                                                <g:actionSubmit class="editAdmin btn btn-primary" action="Edit" value="${g.message(code: 'intentDataType.edit.title')}" />
