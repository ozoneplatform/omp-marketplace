...
<div id="marketContentWrapper" class="widget-marketContentWrapper-wleftbar bootstrap-active">
    <div id="marketContent" style="padding-top: 2%; ">
        ...
        <div class="body">
            <h1><g:message code="intentAction.list.title" encodeAs="HTML" /></h1>
            ...
            <div class="list">
                <table class="listTables table">
                    ...
                    <tbody>
                    <g:each in="${intentActionList}" status="i" var="intentAction">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            <td class="admin_page_list"><g:link action="show" id="${intentAction.id}">${fieldValue(bean:intentAction, field:'title')}</g:link></td>
                            <td class="admin_page_list">${fieldValue(bean:intentAction, field:'description').replaceAll("\n","<br>")}</td>
                            <td class="admin_page_list">${intentAction.uuid.encodeAsHTML()}</td>
                        </tr>
                    </g:each>
                    </tbody>
                </table>
            ...
            <div class="admin_paginate_buttons">
                <g:paginate total="${intentActionTotal}" />
            </div>
            <span class="menuButton admin_page_link"><g:link class="admin_create" action="create"><g:message code="intentAction.create.title" encodeAs="HTML" /></g:link></span>
        </div>
        </div>
    </div>
</body>
