    ...
    <body>
        <div id="marketContentWrapper" class="widget-marketContentWrapper-wleftbar bootstrap-active">
          <div id="marketContent" style="padding-top: 2%; ">
	        ...
	        <div class="body">
	            <h3><g:message code="category.list.title" encodeAs="HTML" /></h3>
	                ...
	                <table class="listTables table" cellpadding="0" cellspacing="0">
	                    ...
	                    <g:each in="${categoryList}" status="i" var="category">
	                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
	                            <td class="admin_page_list"><g:link action="show" id="${category.id}">${fieldValue(bean:category, field:'title')}</g:link></td>
	                            <td class="admin_page_list">${fieldValue(bean:category, field:'description').replaceAll("\n","<br>")}</td>
	                            <td class="admin_page_list">${category.uuid.encodeAsHTML()}</td>
	                        </tr>
	                    </g:each>
	                    </tbody>
	                </table>
	            ...
	            <span class="menuButton admin_page_link"><g:link class="admin_create" action="create"><g:message code="category.create.title" encodeAs="HTML" /></g:link></span>
	        </div>
	     </div>
	   </div>
    </body>
